...
def update_values():
    ...
    current_yard_line.set("45-yard line")
...
canvas.create_text(35, 125, text="END ZONE", angle=90, font=("Helvetica", 14), fill="black")
canvas.create_text(665, 125, text="END ZONE", angle=90, font=("Helvetica", 14), fill="black")
