...
void setup()
{
    ...
    DW3000Ranging.attachBlinkDevice(newBlink);
    ...
    DW3000Ranging.startAsAnchor(ANCHOR_ADD, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false);
...
void newBlink(DW3000Device *device)
{
